...
public class Calculation {
    ...
    public String cc(receive_bag recv , ModelMap map){
        ...
        switch (recv.getRoad_type()){
            case 0:
                money = Work.get_no_0(700,recv.getSite_type(),recv.getNow_size(),bags,recv.getBaby_num());
                break;
            case 1:
                money = Work.get_no_1(recv.getSite_type(),recv.getNow_size(),bags);
                break;
            case 2:
                money = Work.get_no_2(recv.getSite_type(),recv.getNow_size(),bags);
                break;
            case 3:
                money = Work.get_no_3(recv.getSite_type(),recv.getNow_size(),bags);
                break;
            case 4:
                money = Work.get_no_4(recv.getSite_type(),recv.getNow_size(),bags);
                break;
            case 5:
                money = Work.get_no_5(recv.getSite_type(),recv.getNow_size(),bags);
                break;
        }
        map.put("money",money);
        return "result";
